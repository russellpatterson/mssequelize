...
module.exports = (function() {
  ...
  Object.defineProperty(DAO.prototype, "primaryKeyCols", {
    get: function() {
      var primaryKeys = Object.keys(this.__factory.primaryKeys)
  ...
  DAO.prototype.save = function(fields) {
    var self          = this
      , values        = fields ? {} : Utils._.clone(this.values)
    ...
    for (var attrName in this.daoFactory.rawAttributes) {
      if (this.daoFactory.rawAttributes.hasOwnProperty(attrName)) {
        var definition      = this.daoFactory.rawAttributes[attrName]
          ...
          , isAutoIncrement = definition.autoIncrement
    ...
    var cleanValues = {};
    Utils._.each(values, function(value, key){
      if(value){
    ...
    if (!!errors) {
      ...
      var insertQuery = this.QueryInterface.insert(this, this.QueryInterface.QueryGenerator.addSchema(this.__factory), values)
      insertQuery.on("sql", function(sql){console.log(sql)})
      return insertQuery
    } else {
