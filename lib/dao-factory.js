...
module.exports = (function() {
  ...
  Object.defineProperty(DAOFactory.prototype, "primaryKeyCols", {
    get: function() {
      var primaryKeys = Object.keys(this.primaryKeys)
  ...
  DAOFactory.prototype.findAll = function(options, queryOptions) {
    ...
    options = options || {}
    options.attributes = options.attributes || Utils._.keys(this.attributes)
  ...
  */
  ...
  DAOFactory.prototype.bulkCreate = function(records, fields) {
    ...
    // Validate enums
    records = records.map(function(values) {
