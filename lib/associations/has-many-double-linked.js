...
module.exports = (function() {
  ...
  HasManyDoubleLinked.prototype.injectGetter = function(options) {
    ...
    var customEventEmitter = new Utils.CustomEventEmitter(function() {
      ...
      where[self.__factory.connectorDAO.tableName+"."+foreignKey] = {join: self.__factory.target.tableName+"."+targetPrimaryKey}
  ...
  HasManyDoubleLinked.prototype.injectSetter = function(emitterProxy, oldAssociations, newAssociations) {
    var self = this,
      instancePrimaKey = this.instance.primaryKeyCols[0],
      targetPrimaryKey = this.__factory.target.primaryKeyCols[0]
    ...
    destroyObsoleteAssociations
      ...
      .success(function() {
        ...
        unassociatedObjects.forEach(function(unassociatedObject) {
          var attributes = {}
          attributes[self.__factory.identifier] = self.instance[targetPrimaryKey]
          attributes[foreignIdentifier] = unassociatedObject[targetPrimaryKey]
  ...
  HasManyDoubleLinked.prototype.injectAdder = function(emitterProxy, newAssociation) {
    ...
    attributes[this.__factory.identifier] = this.instance[instancePrimaryKey]
    attributes[foreignIdentifier] = newAssociation[targetPrimaryKey]
  ...
  var destroyObsoleteAssociations = function(oldAssociations, newAssociations) {
    ...
    return new Utils.CustomEventEmitter(function(emitter) {
      ...
      obsoleteAssociations.forEach(function(associatedObject) {
        ...
        where[self.__factory.identifier] = self.instance[instancePrimaryKey]
        where[foreignKey] = associatedObject[targetPrimaryKey]
