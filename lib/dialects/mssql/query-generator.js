...
var processAndEscapeValue = function(value) {
  ...
  var escapedValue =  Utils.escape(processedValue)
...
module.exports = (function() {
  var QueryGenerator = {
      ...
      if (options.include) {
        ...
        options.include.forEach(function(include) {
          ...
          query += Utils._.template(joinQuery)({
            ...
            attrLeft:   include.association.source.primaryKeyCols[0],
    ...
    insertQuery: function(tableName, attrValueHash) {
      ...
      var query = "INSERT INTO " + table + " (" + attributes + ") OUTPUT INSERTED.*, IDENT_CURRENT('" + table + "') AS insertId VALUES (" + values + ");"
